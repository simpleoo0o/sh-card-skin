...
2. 选择“照片”图层，通过画布、缩放和旋转控件调整取景。
3. 选择一个上海公共交通卡 Logo 预设，或上传自己的 Logo。
4. 选择“Logo”图层，调整它的位置、大小和角度。
...
上海公共交通卡名称与标识属于其权利人。内置标识的官方来源、浏览器截图原因和可复现处理参数见 [`public/logos/SOURCES.md`](public/logos/SOURCES.md)。
